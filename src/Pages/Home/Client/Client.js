...
const Client = () => {
    ...
    return (
        ...
        <h3 className='text-4xl px-10 py-12 text-center lg:text-4xl text-cyan-700 font-bold  lg:w-3/5 mx-auto'>More than 50,000,000 users worldwide are using our platform</h3>
